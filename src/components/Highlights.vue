    ...
    <div class="highlights-wrapper">
      <div class="highlight">
            ...
            <div class="card-justify">
              <div class="info-main">
                <div class="info-main-num">
                  {{ parseFloat(weatherInfo?.wind?.speed).toFixed(1) }}
                </div>
        ...
        <div class="card-small">
          <div class="card-small-title">Порыв ветра</div>
      ...
      <div class="highlight">
        ...
        <div class="card-small">
          <div class="card-small-title">Ощущается</div>
          <div class="card-small-info">
